 ...
 */
@Component
public class ConfirmationQuestionSkillRuntime {

    private static final String SKILL_ID = "confirmation-question";
    ...
    public ConfirmationQuestionSkillRuntime(
            ChatModel chatModel,
    ...
    public UserConfirmationItems execute(DataProcessingGraphState state) {
        ...
        try {
            ...
            return ChatClient.create(chatModel)
                    ...
                    .call()
                    .entity(UserConfirmationItems.class);
        } catch (Exception ex) {
            throw new IllegalStateException("Failed to execute confirmation-question skill.", ex);
        } finally {
            stateHolder.clear();
        }
    }
    ...
    private String buildSystemPrompt() {
        return """
                You are executing the ConfirmationQuestionSkillNode of a StateGraph workflow.
    ...
    private String serializeState(DataProcessingGraphState state) {
        try {
            ...
            throw new IllegalStateException("Failed to serialize graph state for confirmation-question skill.", ex);
        }
    }
}
